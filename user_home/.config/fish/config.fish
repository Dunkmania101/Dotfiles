...
alias install-skeuos-gtk-gruvbox="mkdir -p ~/ProgramFiles/themes; mkdir -p ~/.local/share/themes; git -C ~/ProgramFiles/themes clone --depth=1 https://github.com/daniruiz/skeuos-gtk.git || git -C ~/ProgramFiles/themes/skeuos-gtk pull; bash -c 'pushd ~/ProgramFiles/themes/skeuos-gtk; ./generate-color-theme.sh Gruvbox \'#ddc7a1\' \'#d4be98\'; cp -r ./themes/* ~/.local/share/themes/; sudo ln -s ./themes/* /usr/share/themes/; popd'"
