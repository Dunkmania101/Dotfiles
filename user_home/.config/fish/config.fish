...
alias wifi-form='set tmpf /etc/resolv.conf.(uuidgen); toggle-dns $tmpf \'0\'; sleep 1; nyxt --profile nosave https://gnu.org; toggle-dns $tmpf \'1\''
...
alias mkprogramfilesdir='mkdir --parents ~/ProgramFiles/$argv'
...
alias install-open-webui='pipx install open-webui --python (find ~/.pyenv/versions/3.11*/bin/python3 | tail -n1) --verbose'
...
alias uu-fish="install-fisher; test -f ~/.config/fish/fish_plugins.save && cp ~/.config/fish/fish_plugins.save ~/.config/fish/fish_plugins; fisher update; fish_update_completions"
...
alias uu-tldr="tldr --update"
alias uu-noguix="uu-arch; uu-fish; uu-nix; uu-flatpak; skipcmd uu-pip; uu-pipx; skipcmd uu-nim; uu-node; uu-emacs; skipcmd uu-graal; skipcmd install-blender-gruvbox; skipcmd install-blender-dracula; skipcmd install-blender-cad-sketcher; install-searxng; skipcmd install-pax-mc; skipcmd install-packwiz-mc; uu-fontcache; skipcmd install-capitaine-cursors-sainnhe; skipcmd install-capitaine-cursors-sainnhe-root; uu-tldr"
...
alias lsa="exa -a"
alias lsal="lsa -lhg"
alias get-winid="xwininfo -display :0"
alias get-kbdin="xdev -event keyboard"
