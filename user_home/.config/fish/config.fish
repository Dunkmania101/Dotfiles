...
alias uu-doom="git -C ~/.config/emacs fetch; git -C ~/.config/emacs pull; doom --force sync; doom --force upgrade; doom sync --force --rebuild; doom --force purge; doom --force sync"
